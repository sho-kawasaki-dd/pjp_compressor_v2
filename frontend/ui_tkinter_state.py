...
class TkUiStateMixin:
    def initialize_ui_state(self) -> None:
        ...
        self.pdf_ll_linearize = tk.BooleanVar(value=defaults['linearize'])
        self.pdf_ll_object_streams = tk.BooleanVar(value=defaults['object_streams'])
        self.pdf_ll_clean_metadata = tk.BooleanVar(value=defaults['clean_metadata'])
        self.pdf_ll_recompress_streams = tk.BooleanVar(value=defaults['recompress_streams'])
        self.pdf_ll_remove_unreferenced = tk.BooleanVar(value=defaults['remove_unreferenced'])
